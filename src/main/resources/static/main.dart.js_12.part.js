...
$__dart_deferred_initializers__.current=function(a,b,c,$){var J,A,B,C={ajK:function ajK(d){this.a=0
this.b=d},aj9:function aj9(d){this.a=0
this.b=d}}
J=c[1]
A=c[0]
B=c[2]
...
x(A.u,[C.ajK,C.aj9])})()
var y={c:A.C("cr")};(function lazyInitializers(){var x=a.lazyFinal
x($,"csx","DX",()=>A.PL(0))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_12",e:"endPart",h:b})})($__dart_deferred_initializers__,"oRUWjJZOPdmGLbb6AV7CbDPh2cU=");