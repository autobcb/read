...
v=(~x>>>0)+(x<<21>>>0)
u=v>>>0
w=(~w>>>0)+((w<<21|x>>>11)>>>0)+C.e.aU(v-u,p)>>>0
v=((u^(u>>>24|w<<8))>>>0)*265
x=v>>>0
w=((w^w>>>24)>>>0)*265+C.e.aU(v-x,p)>>>0
v=((x^(x>>>14|w<<18))>>>0)*21
x=v>>>0
w=((w^w>>>14)>>>0)*21+C.e.aU(v-x,p)>>>0
x=(x^(x>>>28|w<<4))>>>0
w=(w^w>>>28)>>>0
v=(x<<31>>>0)+x
u=v>>>0
...
q.zA()
q.zA()},
zA(){var x=this,w=x.a,v=4294901760*w,u=v>>>0,t=55905*w,s=t>>>0,r=s+u+x.b
w=r>>>0
x.a=w
x.b=C.e.aU(t-s+(v-u)+(r-w),4294967296)>>>0},
Bx(d){var x,w,v,u=this
if(d<=0||d>4294967296)throw B.k(B.i3(y.c+d))
x=d-1
if((d&x)===0){u.zA()
return(u.a&x)>>>0}do{u.zA()
w=u.a
